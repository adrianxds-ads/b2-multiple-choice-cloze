const CACHE_PREFIX="b2mcc-";
const CACHE="b2mcc-v0.3.0";
const ASSETS=["./","./index.html","./styles.css","./app.js","./bank.js","./adrian-visual-system.js","./adaptive-language-dashboard.js","./manifest.webmanifest","./icon.svg"];

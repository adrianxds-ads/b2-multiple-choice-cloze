...
.medal-summary-host{margin:7px 0 13px}.medal-summary-host .ad-medal-strip{gap:10px;margin:9px 0 4px}.medal-summary-host .ad-medal-stat{min-width:104px;padding:8px 11px;grid-template-columns:31px auto;column-gap:7px;border-radius:14px}.medal-summary-host .ad-medal-stat i{width:30px;height:30px;border-width:3px;font-size:12px}.medal-summary-host .ad-medal-stat b{font-size:10px}.medal-summary-host .ad-medal-stat em{font-size:12px}
